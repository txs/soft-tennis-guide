	...
	integrations: [
		starlight({
			...
			sidebar: [
				...
				{
					label: 'Introduction to Soft Tennis',
					translations: {
					...
					items: [
						{ 
							label: 'Differences Between Soft and Hard Tennis', 
						...
						{ 
							label: 'The Charm of Soft Tennis', 
				...
				},
				{
					...
					items: [
						{ 
							label: 'Basic Rules of Soft Tennis', 
							link: '/basics/rules',
							translations: {
						...
						{ 
							label: 'Scoring System of Soft Tennis', 
							link: '/basics/scores',
							translations: {
				...
				{
					label: 'Chapter 1: Warm-up and Preparation Activities',
					translations: {
					...
					items: [
						...
						{ 
							label: 'Coordination and Flexibility Training', 
				...
				{
					label: 'Chapter 2: Basic Movements and Techniques',
					translations: {
					...
					items: [
						...
						{ 
							label: 'Basic Stance and Footwork', 
				...
				{
					label: 'Chapter 3: Serving and Receiving',
					translations: {
				...
				{
					label: 'Chapter 4: Volleying and Defending',
					translations: {
				...
				{
					label: 'Chapter 5: Advanced Skills and Tactics',
					translations: {
				...
				{
					label: 'Chapter 6: Singles and Doubles Matches',
					translations: {
				...
				{
					label: 'Chapter 7: Training and Match Preparation',
					translations: {
					...
					items: [
						{ 
							label: 'Comprehensive Skill Training', 
						...
						{ 
							label: 'Match Mindset and Preparation', 
				...
				},
				{
					...
					items: [
						{ 
							label: 'The Charm and Challenges of Soft Tennis', 
						...
						{ 
							label: 'The Future of Tennis Path', 
